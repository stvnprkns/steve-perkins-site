...
export default function CaseStudyIntro() {
  return (
    <div className="prose max-w-3xl mx-auto text-text-base mb-20">
      ...
      <div className="space-y-6 text-lg">
        ...
        <p>Starting with a data point: <strong>50% of small businesses fail within 5 years</strong>. We set out to improve the survival rate of businesses. A key point that pointed our way was that businesses with a CPA were more successful than those without.</p>
      </div>
    </div>
  );
}
