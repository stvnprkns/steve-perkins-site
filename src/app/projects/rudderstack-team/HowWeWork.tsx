  ...
  return (
    <section id="how-we-work" className="scroll-mt-20" aria-labelledby="how-we-work-title">
      ...
      <article className="flex flex-col items-center">
        ...
        <figure className="w-full max-w-4xl mt-6">
          <CaseStudyImage
      ...
      <section aria-labelledby="tickets-heading" className="w-full max-w-prose">
      ...
      <section aria-labelledby="designing-product-heading" className="w-full max-w-prose">
        ...
        <section aria-labelledby="measuring-impact-heading" className="w-full max-w-prose">
